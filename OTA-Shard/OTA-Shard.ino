...
void candyCorn(){
 ...
 // SETUP SHORT ARM COLORS - PIN 5 :: ttl 70 (arm is 20)
      ...
      fill_solid( shortarmleds, 66, CHSV(HUE_ORANGE,255,255));
      fill_solid( shortarmleds, 35, CHSV(HUE_ORANGE,255,255));
    ...
    // SETUP BODY COLORS - PIN 6
      ...
      fill_solid( leds, 100, CHSV(HUE_ORANGE,255,255));
      fill_solid( leds, 78, CHSV(HUE_ORANGE,255,255));      
      fill_solid( leds, 45, CHSV(HUE_ORANGE,255,255));
